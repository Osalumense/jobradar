  ...
  <div class="auth-card">
    <div class="auth-logo">
      ...
      <div>
        ...
        <div class="tagline">Your AI-powered job matching dashboard.</div>
      </div>
    </div>
...
input {
  width: 100%; box-sizing: border-box; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08);
  border-radius: 10px; padding: 0.75rem 1rem; font-family: inherit; font-size: 0.9rem;
...
.pw-toggle {
  ...
  background: none; border: none; color: #475569; font-size: 0.78rem; font-weight: 500; cursor: pointer; transition: color 0.15s;
}
